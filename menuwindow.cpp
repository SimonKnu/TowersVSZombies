...
{
    menus.push_back(new Menu("Start",sf::VideoMode::getDesktopMode().width/4,sf::VideoMode::getDesktopMode().height/12));
    this->menus.at(0)->changerColor(sf::Color::White);

    menus.push_back(new Menu("About TowersVSZombies",sf::VideoMode::getDesktopMode().width/4,sf::VideoMode::getDesktopMode().height/4));
    menus.push_back(new Menu("Exit",sf::VideoMode::getDesktopMode().width/4,sf::VideoMode::getDesktopMode().height/2.4));
